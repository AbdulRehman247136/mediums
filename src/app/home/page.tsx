...
function Home() {
  return (
    <div className="flex flex-col md:flex-row w-full">
      {/* 📰 Main content */}
      <div className="flex-1 lg:flex-[3] p-0 md:p-4">
        <Tabs defaultValue="for-you" className="w-full">
          <TabsList className="w-full mt-5 gap-5 flex overflow-x-auto whitespace-nowrap scrollbar-hide border-b border-gray-100">
            <TabsTrigger value="for-you" className="px-4">For You</TabsTrigger>
            <TabsTrigger value="featured" className="px-4">Featured</TabsTrigger>
          </TabsList>
