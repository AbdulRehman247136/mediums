      ...
      <div className="flex-1">
        <nav className="flex items-center justify-between bg-white h-16 px-6 border-b-2 border-gray-100 ">
          ...
          <div className="flex items-center gap-8">
            {session ? (
              <>
                <h1 className="text-xl md:text-2xl font-bold cursor-pointer"><Link href="/home"> Medium </Link></h1>
                <p className="text-gray-700 hidden md:block">Draft in {session?.user?.name}</p>
                {typingStatus === "typing" && (
